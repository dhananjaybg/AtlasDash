 ...
 */
"
Write-Output "This script configures a MongoDB App Services app which extracts data from the Atlas DASH API"
...
Write-Output "To visualize the AtlasDash data on a dashboard:"
Write-Output "1. Activate Charts in your Atlas project"
Write-Output "2. Import the dashboard from the included file 'Travelers Atlas Resource Dashboard.charts'"
